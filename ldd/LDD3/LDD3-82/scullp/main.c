...
static int scullp_defer_op(int write, struct kiocb *iocb, const struct iovec *iov, unsigned long niov, loff_t pos)
{
...
static ssize_t scullp_aio_read(struct kiocb *iocb, const struct iovec *iov, unsigned long niov, loff_t pos)
{
    return scullp_defer_op(0, iocb, iov, niov, pos);
}
 
static ssize_t scullp_aio_write(struct kiocb *iocb, const struct iovec *iov,unsigned long niov, loff_t pos)
{
    return scullp_defer_op(1, iocb, iov, niov, pos);
}
