cmd_/root/rtu/otdr/crosstool/用户空间与内核空间数据交换的方式/sysctl-exam-kern.mod.o := gcc -Wp,-MD,/root/rtu/otdr/crosstool/用户空间与内核空间数据交换的方式/.sysctl-exam-kern.mod.o.d  -nostdinc -isystem /usr/lib/gcc/x86_64-redhat-linux/4.4.6/include -Iinclude  -I/usr/src/kernels/2.6.32-279.el6.x86_64/arch/x86/include -include include/linux/autoconf.h -D__KERNEL__ -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Wno-format-security -fno-delete-null-pointer-checks -O2 -m64 -mtune=generic -mno-red-zone -mcmodel=kernel -funit-at-a-time -maccumulate-outgoing-args -fstack-protector -DCONFIG_AS_CFI=1 -DCONFIG_AS_CFI_SIGNAL_FRAME=1 -pipe -Wno-sign-compare -fno-asynchronous-unwind-tables -mno-sse -mno-mmx -mno-sse2 -mno-3dnow -Wframe-larger-than=2048 -Wno-unused-but-set-variable -fno-omit-frame-pointer -fno-optimize-sibling-calls -g -pg -Wdeclaration-after-statement -Wno-pointer-sign -fno-strict-overflow -fno-dwarf2-cfi-asm -fconserve-stack  -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(sysctl_exam_kern.mod)"  -D"KBUILD_MODNAME=KBUILD_STR(sysctl_exam_kern)" -D"DEBUG_HASH=48" -D"DEBUG_HASH2=10" -DMODULE -c -o /root/rtu/otdr/crosstool/用户空间与内核空间数据交换的方式/sysctl-exam-kern.mod.o /root/rtu/otdr/crosstool/用户空间与内核空间数据交换的方式/sysctl-exam-kern.mod.c

deps_/root/rtu/otdr/crosstool/用户空间与内核空间数据交换的方式/sysctl-exam-kern.mod.o := \
  /root/rtu/otdr/crosstool/用户空间与内核空间数据交换的方式/sysctl-exam-kern.mod.c \
...
/root/rtu/otdr/crosstool/用户空间与内核空间数据交换的方式/sysctl-exam-kern.mod.o: $(deps_/root/rtu/otdr/crosstool/用户空间与内核空间数据交换的方式/sysctl-exam-kern.mod.o)
