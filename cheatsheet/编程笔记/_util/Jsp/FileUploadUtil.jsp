...
{
    //初始化
    FileUploadUtil jfu = new FileUploadUtil(request,"D:\\ProgramFiles\\1.work_soft\\tomcat-6.0.18\\webapps\\culture");
    ...
    //message += "\\n textarea:" + jfu.getParameter("textarea");
    message += "\\n file:" + jfu.getParameter("file");
    message += "\\n file2:" + jfu.getParameter("file2");
    message += "\\n parameter size:" + usernameArr.length;
    message += "\\n 檔案上傳成功!";
...
<html>
    ...
    <body>
        <center>
            ...
            <!-- 檔案上傳的 form: method,enctype 必須且固定; target 實現偽Ajax用  -->
            <form action="#" method="post" enctype="multipart/form-data" target="upfile_frame">
                文件上传：<input type="file" name='file' /><br />
                文件上传：<input type="file" name="file2" /><br />
                <input type='text' name="username" value="" /><br />
                <input type='text' name="username" value="" /><br />
                <textarea cols="17" rows="3" name="textarea"></textarea><br />
