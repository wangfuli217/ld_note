...
namespace Barfoo.Library.Drawing
{
    ...
    { 
        ...
        private int _timeout = 400 * 3000;//设置线程超时时长
        private int _width = 300;//缩图宽
        private int _height = 4000;//缩图高
    ...
    class WebPreviewBase: IDisposable
    {
        ...
        public WebPreviewBase(Uri uri,bool fullpage)
        {
           ...
           // _wb.Size = new Size(1024, 4000);//浏览器分辨率为1024x768            
