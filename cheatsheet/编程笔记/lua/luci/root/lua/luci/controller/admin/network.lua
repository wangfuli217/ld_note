...
--	if page.inreq then
		...
		page.leaf = true -- stops parsing the request at this node and goes no further in the dispatching tree
...
--		page.leaf = true
		...
		page = entry({"admin", "network", "diag_emctrl"}, post("diag_emctrl"), nil)
		page.leaf = true
--	end
end
...
function diag_emctrl(addr)
	diag_command("emctrl comm %q 2>&1", addr)
end
