...
err_ipv6_other = bold_on ..
			...
			[[<a href="]] ..
					DISP.build_url("admin", "advance", "ddns", "detail", section) ..
...
m.title = [[</a><a href="]] .. DISP.build_url("admin", "advance", "ddns") .. [[">]] ..
...
m.redirect = DISP.build_url("admin", "advance", "ddns")
