...
runthis "ip netns exec ns1 ip addr add local 10.1.1.2/24 dev veth-ns1"
runthis "ip netns exec ns2 ip addr add local 10.1.1.3/24 dev veth-ns2"
...
runthis "ip ip netns exec ns1 ip addr"
echo ""

read -p ""
runthis "ip ip netns exec  ns2 ip addr"
echo ""
