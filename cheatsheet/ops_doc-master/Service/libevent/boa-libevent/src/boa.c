...
struct event_base *boa_event_base;  
...
static struct event_base* create_event_base(int);  
 ...
 * name:server_handler
 *
 * description: when a connection arrives, this function is invoked.
*/

static void server_handler(evutil_socket_t fd, short what, void *arg)
{
    pending_requests = 1;
}
...
/* XXX tricky1997 
 *
 * Name: create_event_base
 *
 * description: create the boa_event_base
 */
static struct event_base* create_event_base(int server_s)
{
    struct event_base * base = event_base_new();
    server_event = event_new(base, server_s, EV_READ, server_handler, NULL );
