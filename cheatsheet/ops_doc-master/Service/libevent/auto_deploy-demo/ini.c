...
int ini_read_strn (ini_t * handler, char *section, char *name, char *value, size_t n, char *default_value) {
    char *s = NULL;
...
static int ini_read_num (ini_t * handler, char *section, char *name, void *value, bool is_unsigned) {
    char *s = NULL;
...
int ini_read_int (ini_t * handler, char *section, char *name, int *value, int default_value) {
    INI_READ_SIGNED (int);
}

int ini_read_unsigned (ini_t * handler, char *section, char *name, unsigned *value, unsigned default_value) {
    INI_READ_UNSIGNED (unsigned);
}

int ini_read_int8 (ini_t * handler, char *section, char *name, int8_t * value, int8_t default_value) {
    INI_READ_SIGNED (int8_t);
}

int ini_read_uint8 (ini_t * handler, char *section, char *name, uint8_t * value, uint8_t default_value) {
    INI_READ_UNSIGNED (uint8_t);
}

int ini_read_int16 (ini_t * handler, char *section, char *name, int16_t * value, int16_t default_value) {
    INI_READ_SIGNED (int16_t);
}

int ini_read_uint16 (ini_t * handler, char *section, char *name, uint16_t * value, uint16_t default_value) {
    INI_READ_UNSIGNED (uint16_t);
}

int ini_read_int32 (ini_t * handler, char *section, char *name, int32_t * value, int32_t default_value) {
    INI_READ_SIGNED (int32_t);
}

int ini_read_uint32 (ini_t * handler, char *section, char *name, uint32_t * value, uint32_t default_value) {
    INI_READ_UNSIGNED (uint32_t);
}

int ini_read_int64 (ini_t * handler, char *section, char *name, int64_t * value, int64_t default_value) {
    INI_READ_SIGNED (int64_t);
}

int ini_read_uint64 (ini_t * handler, char *section, char *name, uint64_t * value, uint64_t default_value) {
    INI_READ_UNSIGNED (uint64_t);
}

int ini_read_float (ini_t * handler, char *section, char *name, float *value, float default_value) {
    char *s = NULL;
    int ret = ini_read_str (handler, section, name, &s, NULL);
    if (ret == 0) {
        *value = strtof (s, NULL);
...
int ini_read_double (ini_t * handler, char *section, char *name, double *value, double default_value) {
    char *s = NULL;
    int ret = ini_read_str (handler, section, name, &s, NULL);
    if (ret == 0) {
        *value = strtod (s, NULL);
...
int ini_read_ipv4_addr (ini_t * handler, char *section, char *name, struct sockaddr_in *addr, char *default_value) {
    char *s = NULL;
    int ret = ini_read_str (handler, section, name, &s, default_value);
    if (ret < 0)
        return ret;
...
int ini_read_bool (ini_t * handler, char *section, char *name, bool * value, bool default_value) {
    char *s = NULL;
    int ret = ini_read_str (handler, section, name, &s, NULL);
    if (ret == 0) {
        int i;
