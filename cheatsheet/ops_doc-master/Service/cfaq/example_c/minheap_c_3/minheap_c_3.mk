...
##
## Debug
ProjectName            :=minheap_c_3
ConfigurationName      :=Debug
WorkspacePath          := "E:\data\example"
ProjectPath            := "E:\data\example\minheap_c_3"
...
ObjectsFileList        :="minheap_c_3.txt"
PCHCompileFlags        :=
...
Objects0=$(IntermediateDirectory)/main.c$(ObjectSuffix) $(IntermediateDirectory)/heap.c$(ObjectSuffix) 
...
$(IntermediateDirectory)/main.c$(ObjectSuffix): main.c $(IntermediateDirectory)/main.c$(DependSuffix)
	$(CC) $(SourceSwitch) "E:/data/example/minheap_c_3/main.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/heap.c$(ObjectSuffix): heap.c $(IntermediateDirectory)/heap.c$(DependSuffix)
	$(CC) $(SourceSwitch) "E:/data/example/minheap_c_3/heap.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/heap.c$(ObjectSuffix) $(IncludePath)
...
clean:
	...
	$(RM) $(IntermediateDirectory)/heap$(ObjectSuffix)
	$(RM) $(IntermediateDirectory)/heap$(DependSuffix)
	$(RM) $(IntermediateDirectory)/heap$(PreprocessSuffix)
	$(RM) $(OutputFile)
	$(RM) $(OutputFile).exe
	$(RM) "../.build-debug/minheap_c_3"
