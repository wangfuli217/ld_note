...
{
	//int card[5] = {1, 2, 7, 10, 12};
	//int card[5] = {1, 1, 1, 1, 12};
	//int card[5] = {1, 2, 3, 5, 8};
    ...
    if (IsFiveFlowerBull(card, 5))
    {
        printf("FiveFlowerBull.\n");
