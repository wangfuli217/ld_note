...
##
## Debug
ProjectName            :=memcpy_tuning_5
ConfigurationName      :=Debug
WorkspacePath          := "E:\data\example"
ProjectPath            := "E:\data\example\memcpy_tuning_5"
...
ObjectsFileList        :="memcpy_tuning_5.txt"
PCHCompileFlags        :=
...
$(IntermediateDirectory)/main$(ObjectSuffix): main.c $(IntermediateDirectory)/main$(DependSuffix)
	$(CC) $(SourceSwitch) "E:/data/example/memcpy_tuning_5/main.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main$(ObjectSuffix) $(IncludePath)
...
clean:
	...
	$(RM) $(OutputFile)
	$(RM) $(OutputFile).exe
	$(RM) "../.build-debug/memcpy_tuning_5"
