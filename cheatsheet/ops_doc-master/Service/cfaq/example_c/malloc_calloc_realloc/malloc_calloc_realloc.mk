...
##
## Debug
ProjectName            :=malloc_calloc_realloc
ConfigurationName      :=Debug
WorkspacePath          := "D:\data\example"
ProjectPath            := "D:\data\example\malloc_calloc_realloc"
...
ObjectsFileList        :="malloc_calloc_realloc.txt"
PCHCompileFlags        :=
...
$(IntermediateDirectory)/main$(ObjectSuffix): main.c $(IntermediateDirectory)/main$(DependSuffix)
	$(CC) $(SourceSwitch) "D:/data/example/malloc_calloc_realloc/main.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main$(ObjectSuffix) $(IncludePath)
...
clean:
	...
	$(RM) $(OutputFile)
	$(RM) $(OutputFile).exe
	$(RM) "../.build-debug/malloc_calloc_realloc"
