...
##
## Debug
ProjectName            :=c11_example
ConfigurationName      :=Debug
WorkspacePath          := "E:\data\example"
ProjectPath            := "E:\data\example\c11_example"
...
ObjectsFileList        :="c11_example.txt"
PCHCompileFlags        :=
...
CFLAGS   :=  -g -O0 -std=c11 -Wall $(Preprocessors)
ASFLAGS  := 
...
$(IntermediateDirectory)/main.c$(ObjectSuffix): main.c $(IntermediateDirectory)/main.c$(DependSuffix)
	$(CC) $(SourceSwitch) "E:/data/example/c11_example/main.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.c$(ObjectSuffix) $(IncludePath)
