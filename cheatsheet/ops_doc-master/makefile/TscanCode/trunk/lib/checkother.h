...
class TSCANCODELIB CheckOther : public Check {
public:
    ...
    void runChecks(const Tokenizer *tokenizer, const Settings *settings, ErrorLogger *errorLogger) {
		...
		checkOther.checkDuplicateBranch1();//from TSC1.0
		checkOther.checkDuplicateExpression();
		checkOther.checkDuplicateExpression1();//from TSC1.0
		checkOther.checkSuspiciousSemicolon(); 
		checkOther.checkSignOfUnsignedVariable(); 
		checkOther.checkZeroDivision();
		checkOther.checkUnsignedDivision();   //from TSC1.0
		checkOther.checkDuplicateIf();        //from TSC1.0
		checkOther.checkSelfAssignment(); //from TSC1.0
	...
	void checkDuplicateBranch1();//from TSC1.0
	...
	void checkDuplicateExpression1();//from TSC1.0
