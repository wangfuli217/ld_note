...
test_netup_v4() {
  ...
  status=$?
  assertTrue "/usr/local/bin/wm_get_network_conf @ret:${status} @output:${output}" "${status}"
  assertContains "/usr/local/bin/wm_get_network_conf  @output:${output}" "${output}" "0:8070:2000:f110::1"
  assertContains "/usr/local/bin/wm_get_network_conf  @output:${output}" "${output}" "2409:8070:2000:f010::1"
...
7 4    user_custom_id74    apn_custom_name74    0 auth_custom_password74 
7 4    user_custom_id74    apn_custom_name74    0 auth_custom_password74 
7 4    user_custom_id74    apn_custom_name74    1 auth_custom_password74 
7 6    user_custom_id76    apn_custom_name76    1 auth_custom_password76 
7 6    user_custom_id76    apn_custom_name76    0 auth_custom_password76 
7 6    user_custom_id76    apn_custom_name76    0 auth_custom_password76 
7 10   user_custom_id710   apn_custom_name710   1 auth_custom_password710
7 10   user_custom_id710   apn_custom_name710   1 auth_custom_password710
7 10   user_custom_id710   apn_custom_name710   0 auth_custom_password710
EOF
}
...
1  4   user_reserved_id41   apn_reserved_name41   0 auth_reserved_password41
2  4   user_reserved_id42   apn_reserved_name42   0 auth_reserved_password42
3  4   user_reserved_id43   apn_reserved_name43   0 auth_reserved_password43
4  4   user_reserved_id44   apn_reserved_name44   1 auth_reserved_password44
5  4   user_reserved_id45   apn_reserved_name45   1 auth_reserved_password45
6  4   user_reserved_id46   apn_reserved_name46   1 auth_reserved_password46
1  6   user_reserved_id61   apn_reserved_name61   0 auth_reserved_password61
2  6   user_reserved_id62   apn_reserved_name62   0 auth_reserved_password62
3  6   user_reserved_id63   apn_reserved_name63   0 auth_reserved_password63
4  6   user_reserved_id64   apn_reserved_name64   1 auth_reserved_password64
5  6   user_reserved_id65   apn_reserved_name65   1 auth_reserved_password65
6  6   user_reserved_id66   apn_reserved_name66   1 auth_reserved_password66
1  10  user_reserved_id101  apn_reserved_name101  0 auth_reserved_password101
2  10  user_reserved_id102  apn_reserved_name102  0 auth_reserved_password102
3  10  user_reserved_id103  apn_reserved_name103  0 auth_reserved_password103
4  10  user_reserved_id104  apn_reserved_name104  1 auth_reserved_password104
5  10  user_reserved_id105  apn_reserved_name105  1 auth_reserved_password105
6  10  user_reserved_id106  apn_reserved_name106  1 auth_reserved_password106
EOF
}
...
6 4    user_3gpp2_id64    apn_3gpp2_name64    0 auth_3gpp2_password64 
6 4    user_3gpp2_id64    apn_3gpp2_name64    1 auth_3gpp2_password64 
...
7 4    user_del_id74    apn_del_name74    0 auth_del_password74 
7 4    user_del_id74    apn_del_name74    0 auth_del_password74 
7 4    user_del_id74    apn_del_name74    1 auth_del_password74 
7 6    user_del_id76    apn_del_name76    1 auth_del_password76 
7 6    user_del_id76    apn_del_name76    0 auth_del_password76 
7 6    user_del_id76    apn_del_name76    0 auth_del_password76 
7 10   user_del_id710   apn_del_name710   1 auth_del_password710
7 10   user_del_id710   apn_del_name710   1 auth_del_password710
7 10   user_del_id710   apn_del_name710   0 auth_del_password710
EOF
...
0 4    user_del_id04    apn_del_name04    0 auth_del_password04 
0 4    user_del_id04    apn_del_name04    0 auth_del_password04 
0 4    user_del_id04    apn_del_name04    1 auth_del_password04 
0 6    user_del_id06    apn_del_name06    1 auth_del_password06 
0 6    user_del_id06    apn_del_name06    0 auth_del_password06 
0 6    user_del_id06    apn_del_name06    0 auth_del_password06 
0 10   user_del_id010   apn_del_name010   1 auth_del_password010
0 10   user_del_id010   apn_del_name010   1 auth_del_password010
0 10   user_del_id010   apn_del_name010   0 auth_del_password010
EOF
